        ...
        <div class="sidebar-inner slimscroll">
            <div id="sidebar-menu" class="sidebar-menu">
                ...
                <ul class="sidebar-ul">
                    ...
                    <li class="active">
                        <a href="dashboard.php"><img src="assets/img/dashboard_1.png" width="20px" alt="icon"><span>Dashboard</span></a>
                    </li>
                    <li class="submenu">
                        <a href="category.php"><img src="assets/img/categories.png" width="20px" alt="icon"> <span>Categories</span> <span class=""></span></a>
                    ...
                    <li class="submenu">
                        <a href="product.php"><img src="assets/img/products.png" width="20px" alt="icon"> <span>Product</span> <span class=""></span></a>
                        <ul class="list-unstyled" style="display: none;">
                            <li><a href="all-teachers.html"><span>All Teachers</span></a></li>
                            <li><a href="add-teacher.html"><span>Add Teacher</span></a></li>
                            <li><a href="edit-teacher.html"><span>Edit Teacher</span></a></li>
                ...
                <!-- </div> -->
                <!-- <script>
                    // JavaScript to handle the active class based on user interaction
                    $(document).ready(function() {
                        $(".sidebar-ul li").click(function(e) {
                            console.log("Clicked!");
                            // e.preventDefault();
                            $(".sidebar-ul li").removeClass("active"); // Remove the active class from all menu items
                            $(this).addClass("active"); // Add the active class to the clicked menu item
                        });
                    });
                </script> -->
