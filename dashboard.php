...
<body>
                ...
                <ul class="nav float-left">
                    <li>
                        <div class="top-nav-search">
                            ...
                            <form action="https://preadmin.dreamstechnologies.com/html/school/light/search.html">
                ...
                <div class="page-header">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                            <div class="dash-widget dash-widget5" style="background: linear-gradient(180deg, #2FDF84 0%, #8944D7 100%);">
                                <span class="float-left"><img src="assets/img/categorization.png" alt width="80"></span>
                                <div class="dash-widget-info text-right">
                                    <?php
                                    include 'config.php';
                                    $sql = "SELECT COUNT(*) AS total_categories FROM category"; // Count the total categories
                        ...
                        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                            <div class="dash-widget dash-widget5" style="background: linear-gradient(180deg, #2FDF84 0%, #8944D7 100%);">
                                <div class="dash-widget-info text-left d-inline-block">
                                    <?php
                                    include 'config.php';
                                    $sql = "SELECT COUNT(*) AS total_product FROM product"; // Count the total categories
                                    $result = mysqli_query($con, $sql);
                                    $row = mysqli_fetch_assoc($result);
                                ...
                                <span class="float-right"><img src="assets/img/order.png" width="80" alt></span>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                            <div class="dash-widget dash-widget5" style="background: linear-gradient(180deg, #2FDF84 0%, #8944D7 100%);">
                                <span class="float-left"><img src="assets/img/gift.png" alt width="80"></span>
                                <div class="dash-widget-info text-right">
                                    <span> Order</span>
                                    <h3>10,000</h3>
                                </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                            <div class="dash-widget dash-widget5" style="background: linear-gradient(180deg, #2FDF84 0%, #8944D7 100%);">
                                ...
                                <span class="float-right"><img src="assets/img/test.png" alt width="80"></span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- <script>
        ...
        function populateTable() {
            ...
            // Loop through the student array and generate table rows
            students.forEach(function(student) {
                ...
                // Add any action buttons here, such as edit or delete buttons
                actionCell.innerHTML = `<button class="btn btn-primary">Edit</button>`;
